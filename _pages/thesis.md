...
1333238400000
- MARCO PEVARELLO : Studio di tecniche di "Automated Machine Learning": un caso di studio relativo all'entity Matching, (1333238400000)
...
1708300800000
- MATTEO MARTELLA : Studio e implementazione di una soluzione di Business Intelligence basata su Elastic Search, (1708300800000)

1708473600000
- ELEONORA MACCHIONI : Sviluppo Di Un Modulo Per L'estensione Delle FunzionalitÃ  Di Jd Edwards Enterpriseone Attraverso L'integrazione Con L'infrastruttura Oracle Cloud, (1708473600000)
...
1713484800000
- FABIO GIBERTINI : Sviluppo di un classificatore interattivo basato sull'algoritmo NaÃ¯ve Bayes, (1713484800000)
- ALESSANDRO LUPPI : Sperimentazione di tecniche di topic detection e classificazione di organizzazioni sulla base delle loro pagine web, (1713484800000)
- FILIPPO FAVALI : Usare le infobox per predire le categorie delle organizzazioni in Wikipedia, (1713484800000)

1713571200000
- NICOLA STORCHI : L'automazione del processo di patch management, (1713571200000)
- MIRKO MUCCIARINI : Analisi dei flussi informativi legati ai processi logistici dell'azienda Mirage Granito Ceramico SPA, (1713571200000)

1713657600000
- FEDERICO MERCALLI : Search Intent Tool: Predire L'intento Di Ricerca Associato Ad Una Keyword, (1713657600000)
- CLAUDIA MORCACCINI : Studio E Sperimentazione Di Tecniche Per La Categorizzazione Di Testi Brevi: Il Caso D'uso Degli Articoli Scientifici, (1713657600000)
- MIRKO CAVECCHIA : Studio Di Tecniche Di Word Embedding Per Dati Strutturati Finalizzato Al Keyword Search, (1713657600000)
- SAMUELE CAMPIOLI : L'uso Di Tecniche Di Ensemble In Ambito Short Time Series Forecasting, (1713657600000)
- ANDREA SPINAZZOLA : Utilizzo Di Tecniche Di Topic Modelling Applicate A Comunicati Stampa, (1713657600000)

1713744000000
- MATTEO MANNI : Modelli Di Word E Graph Embedding Applicati Alla Toponomastica, (1713744000000)
- STEFANO CAPUCCINI : Applicazione Di Tecniche Statistiche E Modelli Regressivi Di Machine Learning Per L'analisi E La Previsione Di Serie Temporali: Due Casi Di Studio In Ambito Bancario, (1713744000000)

1713830400000
- MARIO CRISTIANO : Progettazione di un'architettura dati attraverso l'uso del paradigma Data Mesh, (1713830400000)
- FEDERICO SILVESTRI : Progettazione, sviluppo e uso di un'applicazione per la stima delle vendite in Inalca Food & Beverage, (1713830400000)

1718928000000
- RICCARDO PICCOLO : Doyle: il modulo per l'estrazione e analisi di dati da un social network, (1718928000000)
- RICCARDO PICCOLO : Doyle: Il Modulo Per L'estrazione E Analisi Di Dati Da Social Network, (1718928000000)

1719014400000
- DAVIDE IAVICOLI : Tecniche Di Active Learning Per Serie Temporali, (1719014400000)
- CECILIA DI COSTANZO : Distillare Conoscenza Da Big Data Testuali: Applicazione Al Caso Di Un Lungo Romanzo E A Brevi Voci Di Glossario, (1719014400000)
- MATTEO ROCCO : Modelli Di Previsione Temporale Nella Produzione Industriale, (1719014400000)
...
- STEFANO SALA : Ricerca per keyword in database relazionali tramite MongoDB, (1721260800000)

1721433600000
- GIORGIA LEONE : STecniche di Information Retrieval Spazio-Temporale su Grafi RDF, (1721433600000)

1721520000000
- LUCA DENTI : Realizzazione di un page builder con la tecnologia React presso webranking, (1721520000000)

1721692800000
- ASIA BERGAMINI : Data Science & HR Analytics: Implementazione di una soluzione end-to-end per l'analisi e il forecast dei dati delle risorse umane in Coopservice., (1721692800000)

1728950400000
- FEDERICA MAZZA : Predire lo stato d'animo evocato da una canzone attraverso l'analisi del testo, (1728950400000)

1729123200000
- TAHIROU EL HADJ MINTHE : Evaluation of different visualization tools and approaches forbgp maps, (1729123200000)
- MATTEO PAGANELLI : Studio di algoritmi per il calcolo parallelo di full disjunction, (1729123200000)

1729209600000
- NICOLÃ’ ALBERI : Sviluppo di un processo elaborativo in una architettura a micro-servizi, (1729209600000)
- LUCA MALAGOLI : Progettazione e sviluppo di un ERP basato su Cloud Computing: tra iaas e saas, (1729209600000)
- NICOLÃ’ GASPARINI : Studio Keyword Tool: Una web application basata su tecniche di 
 ...
 a supporto del Search Engine, (1729209600000)

1729296000000
- LUIGI FUNARO : Implementazione e testing di algoritmi di Entity Resolution basati su regole GUERRA FRANCESCO, (1729296000000)
- FRANCESCO DEL BUONO : Automatic Behavior Analysis in Planet-Scale Systems, (1729296000000)
- MATTEO PICCININI : Confronto di metodi custom e cloud per il riconoscimento di assegni non trasferibili in Credem Banca, (1729296000000)
- MARCO MOSCONI : Tecniche di data profiling applicate all'integrazione di dati., (1729296000000)
- FRANCESCA CHIARA PARENTI : Studio e implementazione di tecniche di analisi predittiva per l'ottimizzazione di servizi bancari, (1729296000000)

1729382400000
- ANDREA BARALDI : Raggruppamenti di spiegazioni per valutare la qualitaÌ€ di un modello DL, (1729382400000)
- ANDREA ARTONI : Data Mining in Zapi, (1729382400000)
- ANDREA MORELLINI : Estrazione di dati da siti di e-commerce tramite scraping per individuare i trend fashion e classificare pagine web presso Webranking, (1729382400000)
- UGO VERGALLO : FUEL: applicazione per smartphone che misura e prevede la stanchezza di persone affette da affaticamento cronico, (1729382400000)

1729555200000
- BRUNO BERTOLI : Sviluppo Di Una Web Api E Di Un Sistema Di Autorizzazione Basato Sul Protocollo Oauth 2.0, (1729555200000)

1729641600000
- RICCARDO BENASSI : Valutare l'impatto di gruppi di parole per motivare le risposte dei modelli per Entity Matching, (1729641600000)

1734393600000
- GRAZIANO GIORGI : Studio e realizzazione di un Hybrid Recommender System per una biblioteca, (1734393600000)

1734825600000
- LORENZO FERRARI : Clustering Di Pagine Web Sulla Base Della SimilaritÃ  Strutturale, (1734825600000)
- SALVATORE PIACENTILE : Mala Uva: Malicious Authentication Log Analyzer For User Vpn Access. NestlÃ© Applied Use Case., (1734825600000)

1734912000000
- DAMIANO SOLERTE : Apache Spark GPU: Elaborazione rapida di dati su GPU attraverso le librerie RAPIDS, (1734912000000)
